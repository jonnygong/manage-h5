<template>
    <section>
        ...
        <el-table :data="list" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
            ...
            <el-table-column prop="thumb" label="头图" width="120">
            ...
            <el-table-column label="更新时间" width="200" :formatter="formateDate"></el-table-column>
            <el-table-column label="创建时间" width="200" :formatter="formateCreateDate"></el-table-column>
            ...
            <el-table-column prop="sort" label="顺序" width="100" sortable></el-table-column>
