        ...
        <el-row>
            ...
            <el-col :span="17" :offset="1">
                ...
                <el-table :data="list" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
                    ...
                    <el-table-column prop="pname" label="分类名称" width="100">
                    </el-table-column>
                    <el-table-column prop="title" label="服务名称" width="100">
                    </el-table-column>
                    ...
                    <el-table-column prop="concact_person" label="联系人姓名" width="100">
                    </el-table-column>
