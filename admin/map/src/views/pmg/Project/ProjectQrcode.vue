            ...
            <el-col :span="17" :offset="1">
                ...
                <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
                    <el-form :inline="true" :model="filters">
                        ...
                        <el-form-item>
                            <el-button type="primary"><a :href="`https://api.kfw001.com/Pmsadmin/Cplace/batchqrcode?park_id=${filters.park_id}&pid=${selectRow.pid}`" target="_blank">二维码图片导出</a></el-button>
                        </el-form-item>
                    </el-form>
                </el-col>
                ...
                <el-col>
                    ...
                    <el-row type="flex" justify="center">
                        <el-button type="primary" @click="handlePrint" :disabled="noData" v-if="list.length !== 0">打印</el-button>
  ...
  export default {
    ...
    methods: {
      ...
      async getListData(loadmore = false) {
        ...
        if (res === null) return;
        console.log(res.param.list.length);
