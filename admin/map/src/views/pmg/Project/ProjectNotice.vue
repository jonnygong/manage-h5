    ...
    <section>
        ...
        <el-row>
            ...
            <el-col :span="17" :offset="1">
                ...
                <el-table :data="list" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
                    ...
                    <el-table-column prop="info" label="通知信息" width="180">
                    </el-table-column>
                    <el-table-column prop="pid" label="项目名称" width="180">
                    </el-table-column>
        ...
        <el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
            <el-form :model="editForm" label-width="100px" :rules="editFormRules" ref="editForm">
                ...
                <el-form-item label="通知信息" prop="info">
                    <el-input v-model="editForm.info" type="textarea" auto-complete="off"></el-input>
                </el-form-item>
            </el-form>
        ...
        <el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false">
            <el-form :model="addForm" label-width="100px" :rules="addFormRules" ref="addForm">
                ...
                <el-form-item label="通知信息" prop="info">
                    <el-input v-model="addForm.info" type="textarea" auto-complete="off"></el-input>
                </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer">
