    ...
    <section>
        ...
        <el-row>
            ...
            <el-col :span="17" :offset="1">
                ...
                <el-table :data="list" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
                    ...
                    <el-table-column prop="id" label="编号ID" width="80" sortable>
                    </el-table-column>
                    <el-table-column prop="name" label="楼盘名称" width="80" sortable>
                    </el-table-column>
                    <el-table-column prop="pid" label="项目ID" min-width="120">
                    </el-table-column>
        ...
        <el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
            <el-form :model="editForm" label-width="100px" :rules="editFormRules" ref="editForm">
                ...
                <el-form-item label="经度" prop="longitude">
                    <el-input v-model.number="editForm.longitude" auto-complete="off"></el-input>
                </el-form-item>
                <el-form-item label="纬度" prop="latitude">
                    <el-input v-model.number="editForm.latitude" auto-complete="off"></el-input>
                </el-form-item>
            </el-form>
        ...
        <el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false">
            <el-form :model="addForm" label-width="100px" :rules="addFormRules" ref="addForm">
                ...
                <el-form-item label="经度" prop="longitude">
                    <el-input v-model.number="addForm.longitude" auto-complete="off"></el-input>
                </el-form-item>
                <el-form-item label="纬度" prop="latitude">
                    <el-input v-model.number="addForm.latitude" auto-complete="off"></el-input>
                </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer">
