            ...
            <el-col :span="17" :offset="1">
                ...
                <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
                    <el-form :inline="true" :model="filters">
                        ...
                        <el-form-item>
                            <el-button type="primary"><a :href="`https://api.kfw001.com/Pmsadmin/Cplace/template`"
                                                         target="_blank">车位模板下载</a></el-button>
                        </el-form-item>
                        <el-form-item>
                            <el-button type="primary">车位模板导入</el-button>
                        </el-form-item>
                    </el-form>
                </el-col>
                ...
                <el-table :data="list" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
                    ...
                    <!-- 图片显示 -->
                    <el-table-column prop="icon" label="车位图片">
  ...
  export default {
    data() {
      return {
        ...
        editFormRules: {
          ...
          cover: [
            {required: true, message: '请上传标识图', trigger: 'blur'}
          ],
          hid: [
            {type: 'number', required: true, message: '请选择内容', trigger: 'blur'}
          ],
    ...
    methods: {
      ...
      handleEditChange(val) {
        this.rList = this.rSource[val].slice(0);
        console.log(this.editForm.firstLoad);
