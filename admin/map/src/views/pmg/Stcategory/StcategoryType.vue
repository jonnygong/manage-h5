            ...
            <el-col :span="17" :offset="1">
                ...
                <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
                    <el-form :inline="true" :model="filters">
                        ...
                        <el-form-item>
                            <el-button type="primary" @click="handleAdd">添加商店分类</el-button>
                        </el-form-item>
                    </el-form>
                </el-col>
                ...
                <el-table :data="list" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
                    ...
                    <el-table-column prop="c_name" label="分类名称">
                    </el-table-column>
                    <el-table-column prop="pname" label="父级名称">
                    </el-table-column>
    ...
    methods: {
      ...
      _uploadImage(file, type, key) {
        ...
        reader.onload = async () => {
          ...
          const res = await this.$http.post('imageUpload', param);
          if (res === null) return;
