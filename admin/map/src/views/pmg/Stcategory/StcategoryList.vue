        ...
        <el-row>
            ...
            <el-col :span="17" :offset="1">
                ...
                <el-table :data="list" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
                    ...
                    <el-table-column prop="pname" label="商店分类名称" width="100">
                    </el-table-column>
                    <el-table-column prop="name" label="商店名称" width="100">
  ...
  export default {
    ...
    methods: {
      ...
      async handleEdit(index, row) {
        ...
        this.map.lng = res.param.list.longitude;
        this.map.lat = res.param.list.latitude;
