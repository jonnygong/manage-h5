    ...
    methods: {
      async handleSave() {
        ...
        let params = {
          ...
          rids: this.formatToIds(this.roleSels) || [],
          pids: this.formatToIds(this.projectSels) || [],
          resources: this.getCheckedKeys('authTree') || []
        };
      ...
      async getListData() {
        ...
        // 勾选已知选项（角色和项目权限）
        this.roleSels = this.formatCheckedId(this.role, check_role === null ? [] : check_role.split(","));
        this.projectSels = this.formatCheckedId(this.project, check_project === null ? [] : check_project.split(","));
      ...
      _removeAuth(source) {
        ...
        console.log('before:', allAuth.slice(0));
        source.forEach(item => {
        ...
        console.log('after:', allAuth.slice(0));
      ...
      _addAuth(source) {
        ...
        console.log('addBefore', allAuth.slice(0));
        let result = Array.from(new Set(allAuth));
        console.log('addAfter', result);
        // 数组去重
