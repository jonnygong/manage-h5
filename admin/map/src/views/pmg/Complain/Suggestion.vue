        ...
        <el-row>
            ...
            <el-col :span="17" :offset="1">
                ...
                <el-table :data="list" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
                    ...
                    <el-table-column prop="cname" label="建议内容">
                    </el-table-column>
                ...
                <el-col :span="24" class="toolbar">
                    <el-button type="danger" @click="batchAction('remove','suggest')" :disabled="this.sels.length===0">批量删除
                    </el-button>
                    <el-button type="warning" @click="batchAction('disable','suggest')" :disabled="this.sels.length===0">
                        处理
                    </el-button>
                    <el-button type="primary" @click="batchAction('active','suggest')" :disabled="this.sels.length===0">
                        未处理
                    </el-button>
