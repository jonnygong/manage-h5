            ...
            <el-col :span="17" :offset="1">
                ...
                <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
                    <el-form :inline="true" :model="filters">
                        ...
                        <el-form-item>
                            <el-select v-model="filters.pcid" placeholder="报修分类">
                                <el-option
                ...
                <el-table :data="list" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
                    ...
                    <el-table-column prop="c_name" label="报修类型" width="100">
                    </el-table-column>
                    <el-table-column prop="pname" label="所属分类" width="100">
                    </el-table-column>
                    <el-table-column prop="cover" label="图片">
                        <template scope="scope">
                            <el-popover trigger="hover" placement="top">
                                <div class="ad-img">
                                    <img :src="scope.row.cover" :alt="scope.row.content" width="200" height="auto"
                    ...
                    <el-table-column prop="content" label="报修内容" min-width="200">
                    </el-table-column>
                    ...
                    <el-table-column label="操作" width="150" fixed="right">
                        <template scope="scope">
                            <el-button size="small" @click="handleEdit(scope.$index, scope.row)">回馈</el-button>
