        ...
        <el-table :data="list" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
            ...
            <el-table-column label="操作" width="280" fixed="right">
                <template scope="scope">
                    ...
                    <el-button size="small" @click="toSubwayPlate(scope.row)">站点管理</el-button>
    ...
    export default {
        ...
        methods: {
            ...
            async getListData() {
                ...
                const res = await this.$http.post(`mapadminSubwayList`, params);
            ...
            async handleEdit(index, row) {
                ...
                const res = await this.$http.post(`mapadminSubwayEdit`, params);
                if (res === null) return;
                ...
                this.$refs.editForm.validate((valid) => {
                    if (valid) {
                        this.$confirm('确认提交吗？', '提示', {}).then(async () => {
                            ...
                            const res = await this.$http.post(`mapadminSubwayEditsave`, params);
                ...
                this.$refs.addForm.validate((valid) => {
                    if (valid) {
                        this.$confirm('确认提交吗？', '提示', {}).then(async () => {
                            ...
                            const res = await this.$http.post(`mapadminSubwayAddsave`, params);
