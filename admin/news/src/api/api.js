...
// 分类添加保存
export const updateRebellionType = params => {
    return axios.post('/Newsadmin/Keyword/update', params)
};
// 分类修改
export const infoRebellionType = params => {
    return axios.post('/Newsadmin/Keyword/info', params)
};
// 状态修改
...
// };
// 记者信息修改
export const infoReporter = params => {
    return axios.post('/Newsadmin/Reporter/info', params)
};
// 添加记者信息保存
...
// 修改记者信息保存
export const updateReporter = params => {
    return axios.post('/Newsadmin/Reporter/update', params)
};
// 记者状态修改
...
// 记者回复
export const getReporterUpdate = params => {
    return axios.post('/Newsadmin/Qa/update', params)
};
// 记者回复
export const getReporterInfo = params => {
    return axios.post('/Newsadmin/Qa/info', params)
};
// 记者回复保存
export const getReporterAdd = params => {
    return axios.post('/Newsadmin/Qa/add', params)
};
// 获取信息的子分类列表
...
export const publicInfo = params => {
  return axios.post('/Newsadmin/Set/info', params)
};
export const publicSave = params => {
  return axios.post('/Newsadmin/Set/save', params)
};
